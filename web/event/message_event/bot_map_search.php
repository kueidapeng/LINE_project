<?php
	...
	$actions = array(
		new \LINE\LINEBot\TemplateActionBuilder\MessageTemplateActionBuilder(emoji('1F4CD')." 類別搜尋",'類別搜尋'),
		new \LINE\LINEBot\TemplateActionBuilder\MessageTemplateActionBuilder(emoji('1F4CD')." 關鍵字搜尋",'關鍵字搜尋')
		);
